...
struct nvt_autotest_offset {
	...
	uint32_t *pen_tip_x_data_p;
	uint32_t *pen_tip_x_data_n;
	uint32_t *pen_tip_y_data_p;
	uint32_t *pen_tip_y_data_n;
	uint32_t *pen_ring_x_data_p;
	uint32_t *pen_ring_x_data_n;
	uint32_t *pen_ring_y_data_p;
	uint32_t *pen_ring_y_data_n;
	uint32_t *pen_tip_x_noise_data_p;
	uint32_t *pen_tip_x_noise_data_n;
	uint32_t *pen_tip_y_noise_data_p;
	uint32_t *pen_tip_y_noise_data_n;
	uint32_t *pen_ring_x_noise_data_p;
	uint32_t *pen_ring_x_noise_data_n;
	uint32_t *pen_ring_y_noise_data_p;
	uint32_t *pen_ring_y_noise_data_n;
};
